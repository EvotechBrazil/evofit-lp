...
const ROUND2: System[] = [
  {
    ...
    desc: 'Base editorial clara com o AZUL EvoFit como cor de marca (display, outline e botões), laranja como acento, seções navy e energia kinetic (itálicos, marquee, sombras duras).',
    chip: '#2277ee',
    chip2: '#f08020',
    badge: '🏆 ESCOLHIDO',
  },
