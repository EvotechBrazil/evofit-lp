...
const ROUND2: System[] = [
  {
    ...
    desc: 'Base editorial clara, laranja EvoFit como acento, seções navy alternadas e a energia kinetic (itálicos, marquee, sombras duras).',
    chip: '#f08020',
    chip2: '#0a1526',
    badge: '★ NOVO — pedida do Tiago',
  },
  {
    n: '07',
    href: '/ds/7',
