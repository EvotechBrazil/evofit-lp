...
const ROUND2: System[] = [
  {
    ...
    desc: 'Base editorial clara com o azul escuro EvoFit como cor de marca (display, outline e botões), laranja como acento, seções navy e energia kinetic (itálicos, marquee, sombras duras).',
    chip: '#16468a',
    chip2: '#f08020',
    badge: '🏆 ESCOLHIDO',
  },
